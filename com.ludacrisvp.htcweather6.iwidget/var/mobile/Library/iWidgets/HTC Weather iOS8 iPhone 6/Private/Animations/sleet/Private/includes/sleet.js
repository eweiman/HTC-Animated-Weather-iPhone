const NUMBER_OF_drop = 90; // drop to show on screen
const NUMBER_OF_IMAGES = 7; // images + 1
function init() {
...
function createAdrop() {
    ...
    image.src = "sleet/Private/images/drop" + randomInteger(1, NUMBER_OF_IMAGES) + ".png";
    dropDiv.style.top = pixelValue(randomInteger(-15, -50));
    dropDiv.style.left = pixelValue(randomInteger(0, 414));
